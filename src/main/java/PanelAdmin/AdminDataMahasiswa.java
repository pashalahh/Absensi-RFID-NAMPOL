 ...
 * @author ADVAN
 */
public class AdminDataMahasiswa extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminDataMahasiswa.class.getName());

    /**
     * Creates new form AdminDataMahasiswa
     */
    public AdminDataMahasiswa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblLogScan4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIM", "Nama", "Kelas", "No Telepon", "RFID"
            }
        ));
        jScrollPane5.setViewportView(tblLogScan4);

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Daftar Mata Kuliah");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icon/pencarian.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AdminDataMahasiswa().setVisible(true));
    }
